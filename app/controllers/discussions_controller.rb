class DiscussionsController < ApplicationController
    ...
    def create
        discussion = Discussion.create(title:discussion_params[:title],content:discussion_params[:content],user_id:discussion_params[:user_id],topic: discussion_params[:topic],is_deleted:false)
    ...
    def discussion_params
        ...
        params.permit(:id,:title,:content,:user_id,:is_deleted,:topic).merge(date: combined_datetime)
      end
